...
export function localVirtualAssistantAnswer(message, context = {}) {
  ...
  if (q.includes('cont') || q.includes('account') || q.includes('profil') || q.includes('profile')) {
    return {
      answer: context?.role === 'professor'
        ...
        : 'Contul de student foloseste emailul institutional, universitatea detectata, facultatea detectata si profilul din onboarding. Daca onboarding-ul apare din nou, completeaza-l o data si profilul ramane salvat local.',
  ...
  if (q.includes('parola') || q.includes('cod') || q.includes('login') || q.includes('logare') || q.includes('sign in')) {
    return {
      answer: 'Autentificarea foloseste un email institutional si o parola de acces institutionala.',
