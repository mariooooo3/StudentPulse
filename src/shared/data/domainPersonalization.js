...
const EXTRA_SKILL_SWAP = {
  LAW: [
    { id:1, name:'Raluca Neagu',  avatar:'RN', teaches:'Redactare acte juridice', learns:'Excel juridic & statistică', teachLevel:'Avansat',    learnLevel:'Beginner',   match:true,  online:true  },
    ...
    { id:3, name:'Ioana Stănescu',avatar:'IS', teaches:'Retorică & pledoarie',    learns:'Drept notarial',            teachLevel:'Avansat',    learnLevel:'Beginner',   match:false, online:true  },
    { id:4, name:'Andrei Lupu',   avatar:'AL', teaches:'Latină juridică',         learns:'Drept penal european',     teachLevel:'Intermediar',learnLevel:'Beginner',   match:true,  online:true  },
  ],
  GEOGRAPHY: [
    { id:1, name:'Ionela Dănilă', avatar:'ID', teaches:'QGIS & ArcGIS',           learns:'Python GeoPandas',          teachLevel:'Avansat',    learnLevel:'Beginner',   match:true,  online:true  },
    ...
    { id:3, name:'Maria Apintei', avatar:'MA', teaches:'Cartare de teren GPS',     learns:'Modelarea 3D a reliefului', teachLevel:'Avansat',    learnLevel:'Beginner',   match:true,  online:false },
  ],
  PSYCHOLOGY: [
    ...
    { id:2, name:'Alex Radu',     avatar:'AR', teaches:'SPSS & R pentru psih.',    learns:'Interviu clinic structurat', teachLevel:'Avansat',    learnLevel:'Beginner',   match:true,  online:true  },
    { id:3, name:'Laura Iftode',  avatar:'LI', teaches:'Tehnici CBT & ACT',        learns:'Testare neuropsihologică',  teachLevel:'Intermediar',learnLevel:'Beginner',   match:false, online:false },
    { id:4, name:'Andrei Maxim',  avatar:'AM', teaches:'Psihologie organizațională',learns:'Psihodiagnoză proiectivă', teachLevel:'Intermediar',learnLevel:'Beginner',   match:true,  online:true  },
  ],
  SPORTS: [
    { id:1, name:'Bogdan Munteanu',avatar:'BM', teaches:'Tehnica alergării',       learns:'Nutriție sportivă avansată',teachLevel:'Avansat',    learnLevel:'Beginner',   match:true,  online:true  },
    ...
    { id:3, name:'Florin Dragnea', avatar:'FD', teaches:'Antrenament de forță',    learns:'Biomecanica mișcărilor',   teachLevel:'Avansat',    learnLevel:'Beginner',   match:false, online:true  },
  ],
  MUSIC: [
    { id:1, name:'Mara Dobre',    avatar:'MD', teaches:'Solfegiu & intonație',     learns:'Software de notație (Sibelius)', teachLevel:'Avansat', learnLevel:'Beginner', match:true,  online:true  },
    ...
    { id:3, name:'Ioana Neagă',   avatar:'IN', teaches:'Repertoriu baroc & clasic',learns:'Improvizație jazz',         teachLevel:'Intermediar',learnLevel:'Beginner',   match:true,  online:false },
  ],
  THEOLOGY: [
    { id:1, name:'Nicolae Bratu', avatar:'NB', teaches:'Lectură patristică (greacă)',learns:'Limbă ebraică biblică',  teachLevel:'Intermediar',learnLevel:'Beginner',   match:true,  online:true  },
    { id:2, name:'Ioana Micu',    avatar:'IM', teaches:'Muzică psaltică',           learns:'Iconografie & artă sacră', teachLevel:'Avansat',    learnLevel:'Beginner',   match:false, online:true  },
  ...
  ARCHITECTURE: [
    { id:1, name:'Diana Tudoran', avatar:'DT', teaches:'Rhino 3D & Grasshopper',   learns:'Urbanism & planificare',    teachLevel:'Avansat',    learnLevel:'Beginner',   match:true,  online:true  },
    { id:2, name:'Vlad Popescu',  avatar:'VP', teaches:'Revit BIM',                learns:'Restaurare & patrimoniu',  teachLevel:'Intermediar',learnLevel:'Beginner',   match:true,  online:true  },
    ...
    { id:4, name:'Andrei Stroe',  avatar:'AS', teaches:'Istoria arhitecturii',     learns:'Render Lumion & V-Ray',    teachLevel:'Avansat',    learnLevel:'Beginner',   match:true,  online:true  },
  ],
  THEATER: [
    { id:1, name:'Ioana Ciobanu', avatar:'IC', teaches:'Improvizație teatrală',    learns:'Regie de film',             teachLevel:'Avansat',    learnLevel:'Beginner',   match:true,  online:true  },
    { id:2, name:'Petru Vlad',    avatar:'PV', teaches:'Analiza textului dramatic', learns:'Mișcare contemporană',      teachLevel:'Intermediar',learnLevel:'Beginner',   match:false, online:true  },
...
const EXISTING_SKILL_SWAP = {
  SCIENCES: [
    { id:1, name:'Cristina Florea',  avatar:'CF', teaches:'Analiză Matematică', learns:'Programare Python & R',      teachLevel:'Avansat',    learnLevel:'Beginner',   match:true,  online:true  },
    { id:2, name:'Radu Antohi',      avatar:'RA', teaches:'Fizică aplicată',    learns:'GIS & date geospațiale',    teachLevel:'Intermediar',learnLevel:'Beginner',   match:false, online:true  },
  ...
  HUMANITIES: [
    ...
    { id:2, name:'Andrei Ghitta',    avatar:'AG', teaches:'Cercetare de arhivă',    learns:'Digital humanities & Excel',  teachLevel:'Intermediar',learnLevel:'Beginner',   match:true,  online:false },
    { id:3, name:'Daniela Tamba',    avatar:'DT', teaches:'Analiță literară',       learns:'Tehnici de interviu oral',    teachLevel:'Avansat',    learnLevel:'Beginner',   match:false, online:true  },
  ],
  ECONOMICS: [
    { id:1, name:'Mădălina Apostol', avatar:'MA', teaches:'Marketing digital & SEO', learns:'SQL & Power BI',            teachLevel:'Avansat',    learnLevel:'Beginner',   match:true,  online:true  },
    ...
    { id:3, name:'Ioana Brînzan',    avatar:'IB', teaches:'Econometrie & Statistică',learns:'Prezentare & public speaking', teachLevel:'Intermediar',learnLevel:'Beginner',  match:false, online:false },
  ],
  MEDICINE: [
    ...
    { id:2, name:'Bogdan Tăbăcaru',  avatar:'BT', teaches:'Farmacologie clinică',    learns:'Tehnici de suturare',       teachLevel:'Intermediar',learnLevel:'Beginner',   match:true,  online:true  },
    { id:3, name:'Diana Costache',   avatar:'DC', teaches:'Biochimie medicală',      learns:'Interpretare EKG',          teachLevel:'Avansat',    learnLevel:'Beginner',   match:false, online:false },
  ],
  PHARMACY: [
    { id:1, name:'Mihaela Săndulescu',avatar:'MS', teaches:'Chimie organică — mecanisme', learns:'Programare Python pentru farmacovigil.', teachLevel:'Avansat', learnLevel:'Beginner', match:true, online:true },
    { id:2, name:'Radu Florea',       avatar:'RF', teaches:'Botanică & fitochimie', learns:'Limbă latină farmaceutică',  teachLevel:'Intermediar',learnLevel:'Beginner',   match:false, online:true  },
  ...
  ENGINEERING: [
    ...
    { id:2, name:'Teodora Căpraru',   avatar:'TC', teaches:'Simulare Multisim',      learns:'Proiectare CAD 3D (Fusion)', teachLevel:'Intermediar',learnLevel:'Beginner',   match:true,  online:true  },
    { id:3, name:'Sorin Iftodi',      avatar:'SI', teaches:'Rezistența materialelor',learns:'Python pentru inginerie',    teachLevel:'Avansat',    learnLevel:'Beginner',   match:false, online:false },
  ],
  ARTS: [
    { id:1, name:'Bianca Olaru',      avatar:'BO', teaches:'Tehnici de desen clasic', learns:'Ilustrație digitală (Procreate)', teachLevel:'Avansat', learnLevel:'Beginner', match:true, online:true },
    ...
    { id:3, name:'Ana Ciocan',        avatar:'AC', teaches:'Istoria artei occidentale',learns:'Design de interior 3D',    teachLevel:'Intermediar',learnLevel:'Beginner',   match:true,  online:false },
  ],
}
